      ...
      child: InkWell(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: _isDragging
                ? (isDark ? AppColors.deepBlue.withValues(alpha: 0.8) : AppColors.champagneGold.withValues(alpha: 0.1))
                : (isDark ? AppColors.deepBlue : AppColors.surfaceLight),
            border: Border.all(
              color: _isDragging
                  ? AppColors.champagneGold
                  : (isDark ? AppColors.overlayDark : AppColors.softGrey),
                ...
                Column(
                  ...
                  children: [
                    Icon(
                      ...
                      size: 40,
                      color: _isDragging ? AppColors.champagneGold : AppColors.textMuted,
                    ),
