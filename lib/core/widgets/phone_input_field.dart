...
class _PhoneInputFieldState extends State<PhoneInputField> {
  ...
  Widget build(BuildContext context) {
    ...
    final borderColor = isDark ? Colors.white12 : AppColors.softGrey;
    final fillColor = isDark ? AppColors.deepBlue : Colors.white;
    final textColor = isDark ? Colors.white : AppColors.imperialNightBlue;
              ...
              child: TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  focusedBorder: OutlineInputBorder(
                    borderSide:
                        const BorderSide(color: AppColors.champagneGold, width: 1.2),
                    borderRadius: BorderRadius.circular(AppDimensions.radiusSm),
                  ),
...
class _CountryPickerSheetState extends State<_CountryPickerSheet> {
  ...
  Widget build(BuildContext context) {
    ...
    final l10n = AppLocalizations.of(context)!;
    final bgColor =
        isDark ? AppColors.imperialNightBlue : AppColors.ecruWhite;
                  ...
                  decoration: InputDecoration(
                    ...
                    focusedBorder: OutlineInputBorder(
                      borderSide: const BorderSide(
                          color: AppColors.champagneGold, width: 1.2),
                      borderRadius: BorderRadius.circular(AppDimensions.radiusSm),
                    ),
                  ),
                ),
